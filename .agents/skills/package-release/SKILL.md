...
description: "Use this skill when preparing Ugarit package releases: CHANGELOG.md updates, generated release notes, GitHub release workflows, version checks, tags, release validation, or release automation changes. Never publish autonomously."
license: MIT
metadata:
  author: ugarit
---
...
3. Confirm whether version metadata needs to change; many Ugarit packages rely on Git tags rather than a hardcoded package version.
