...
- Test routes with Testbench HTTP requests, commands with Scribe assertions, migrations with a SQLite test database, and workbench behavior after `composer build` when needed.
