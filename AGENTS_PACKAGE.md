...
This repository is a Ugarit package. Keep the package focused, idiomatic, and easy for Ugarit developers to install, test, and maintain.
...
- Prefer explicit Ugarit package code over helper abstractions unless the extension point is real.
